...
for (let i = 0; i < 2; i++) {
  books.push({
    _id: i + 1,
    title: names[getRandomInt(0, names.length)],
    author: statuses[getRandomInt(0, statuses.length)],
    description: getRandomInt(200, 1000),
    rating: owners[getRandomInt(0, owners.length)]
  });
}
